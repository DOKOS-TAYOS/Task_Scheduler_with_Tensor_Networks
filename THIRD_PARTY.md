...
The notices below cover third-party packages declared in `requirements.txt`.
Those packages are not vendored here; install them separately and consult the
license text shipped with each package for authoritative terms.
